...
| # | Chart | Insight |
|---|---|---|
| 1 | Monthly Revenue Trend | Sales patterns over time |
| 2 | Category Revenue & Volume | Best performing products |
| 3 | Order Status Distribution | Delivery vs cancellation breakdown |
| 4 | Fulfillment Method | Amazon vs Merchant fulfillment |
| 5 | Top 10 States by Revenue | Geographic revenue leaders |
| 6 | Size Distribution | Most popular product sizes |
| 7 | B2B vs B2C Split | Customer type breakdown |
| 8 | Revenue Heatmap (Category × Month) | Seasonal demand patterns |
| 9 | Order Amount Distribution | Pricing & spend behavior |
| 10 | Cancellation Rate by Category | Problem categories |
| 11 | Top 10 Cities by Revenue | City-level geographic analysis |
| 12 | Customer Segmentation by Order Value | Budget/Mid/Premium/High-value segments |
...
Place `Amazon Sale Report.csv` in the project folder.
...
All 12 charts will be saved as PNG files in the same folder.
